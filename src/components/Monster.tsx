...
export function Monster({ equipped, mood = 'idle', size = 160, className }: Props) {
  const uid = useId()
  ...
  return (
    <svg viewBox="0 0 220 250" width={size} height={size * (250 / 220)} className={className} aria-label="Your monster">
      ...
      {/* mouth by mood */}
      {mood === 'idle' && <path d="M88 155 Q110 170 132 155" fill="none" stroke="#1f2937" strokeWidth="5" strokeLinecap="round" />}
      ...
      {mood === 'sad' && <path d="M88 168 Q110 152 132 168" fill="none" stroke="#1f2937" strokeWidth="5" strokeLinecap="round" />}
